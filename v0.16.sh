...
echo ""
echo "============================================================"
echo "[2/5] DEFINITION OF THE GLUSTERFS SYSTEM USER"
echo "============================================================"
...
echo "The glusterfs/gluster user was not found locally. I'm identifying it through the owner of /var/lib/glusterd..."
